      ...
      <table className="eventsTable">
        <tbody>
          ...
          {eventData[0] && (
            ...
            <div className="table-text">{eventData[0].date} :בתאריך</div>
            <div className="table-text">{eventData[0].time} :בשעה</div>
            </th>
          )}
          </tr>
        </tbody>
  ...
  <tr className="tableBords">
    <td className="tableBords">
      <div>
        ...
        <p>{eventData[0] && location && (
          <img src={location} alt="Event Logo" className="event-logo" />
        )} {eventData[0] ? eventData[0].place : ''}</p>
